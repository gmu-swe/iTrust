...
abstract public class iTrustSeleniumTest extends TestCase {
	 ...
	 */
	/**ADDRESS*/
	public static final String ADDRESS = "http://localhost:" + System.getProperty("tomcat.port") + "/iTrust/";
	protected static final String BASE_URL = "http://localhost:" + System.getProperty("tomcat.port");
	/**gen*/
...
//				connector.setPort(8080);
				...
				//Deploy the app
				String warFile = "target/iTrust-21.0.01.war";
